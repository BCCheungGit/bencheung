    ...
    <>
        ...
        <div className="w-full h-full flex md:flex-row flex-col md:gap-10 gap-2">
          <div className="md:w-1/2 w-full lg:flex lg:flex-col hidden">
            ...
            <div className="flex flex-col gap-4 justify-center items-center">
              ...
              <p className="text-white text-[9px] mb-5">
          ...
          <div className="flex flex-col lg:w-1/2 w-full lg:border-l-2 sm:p-8 p-0 rounded-xl">
            <h1 className="sm:text-[30px] text-[20px] text-white uppercase border-b-2 w-full tracking-wider">
              About Me.
            </h1>
            <p className="mt-10">
              I am a sociable, quick-learning, curious thinker.
            </p>
            <p className="mt-5">
              I mainly work with TypeScript/JavaScript, Python, Java, and C. I
              am especially proficient with full-stack web development, but am
      ...
      <div className="flex flex-row flex-wrap justify-center gap-10">
        {technologies.map((technology, index) => (
          <div
            className="w-28 h-28 sm:w-56 sm:h-56 flex flex-col gap-4 justify-center items-center"
